                    ...
                    <div class="card-body">
                        ...
                        <div class="list-group">
                            <div class="list-group-item list-group-item-action flex-column align-items-start">
                                ...
                                <p class="mb-1">{{ isset($detail['kode_barangMasuk']) ? $detail['kode_barangMasuk'] : 'Item code tidak ada' }}</p>
                            </div><div class="list-group-item list-group-item-action flex-column align-items-start">
                                <div class="d-flex w-100 justify-content-between">
                                    <h5 class="mb-1">Nama</h5>
                                </div>
                                <p class="mb-1">{{ isset($detail['nama_barangMasuk']) ? $detail['nama_barangMasuk'] : 'Item name tidak ada' }}</p>
                            </div>
                            <div class="list-group-item list-group-item-action flex-column align-items-start">
                                <div class="d-flex w-100 justify-content-between">
