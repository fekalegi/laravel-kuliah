        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{url('barangKeluar')}}">
                            @csrf
                            <h1>Form Insert</h1>
                            <div class="form-group">
                                ...
                                <label for="name" class="required">Customer</label>
                                @error('kode_customer')
                                <div class="error">{{ $message }}</div>
                                @enderror
                                {{ Form::select('kode_customer',$customer, null,['class' => 'form-control','placeholder'=> '-- Pilih --']) }}
